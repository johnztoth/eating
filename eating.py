...
Read in an environment list from an external file. This is a grid of numbers.
Create a number of Agents, each with a random x and y coordinate.
As the agent moves it eats the environment where it lands.
...
The agent must stay within the bounds of the model.
